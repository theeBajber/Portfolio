...
export default function StatusBar({ className }) {
  ...
  return(
    <div className={`bg-black/20 backdrop-blur-2xl flex items-center justify-between ${className}`}>
      <div className="pl-2 flex justify-between items-center w-[15%] min-w-50 text-gray-300">
        ...
        <div className={`${urbanist.className} font-bold text-white`}>Faraj Salim</div>
